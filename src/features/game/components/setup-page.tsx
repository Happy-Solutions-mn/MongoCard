              ...
              >
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">2–20 хүн</p>
                  </div>
                </div>
              ...
              >
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Заавал биш — хоосон үлдээвэл автомат нэр</p>
                  </div>
                </div>
            ...
            >
              ...
              >
                <div className="mb-5 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Зөвхөн нэг сонголт — анхдагч: Дунд
                    </p>
                  </div>
                </div>
                ...
                <div
                  ...
                  role="radiogroup"
                  aria-label="Картын түвшин"
                >
                  {(["light", "medium", "hot"] as const).map((category, index) => {
                    const isSelected = selectedCategories[0] === category;
                    return (
                      <motion.button
                        key={category}
                        type="button"
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={() => selectCategoryLevel(category)}
                        className={cn(
      ...
      >
        {setupStep === 1 ? (
          <Button
            size="lg"
            className={cn(
              "w-full gap-2 rounded-2xl bg-gradient-to-r from-primary to-primary/90 font-bold text-lg h-16",
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:gap-3">
            <Button
              ...
              variant="outline"
              size="lg"
              className="h-14 shrink-0 rounded-2xl sm:h-16 sm:w-36"
            ...
            <Button
              size="lg"
              className={cn(
                "flex-1 gap-3 rounded-2xl bg-gradient-to-r from-primary to-primary/90 font-bold text-lg h-14 sm:h-16",
                "shadow-xl shadow-primary/30 transition-all hover:shadow-2xl hover:shadow-primary/40",
